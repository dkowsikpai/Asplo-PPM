...
<head>
    ...
    <title>Open PPM | Customers</title>
...
<body>
    ...
    <main>
        ...
        <div class="grid">
            <table class="flex-grid-div" id="customer_flex" style="display:none"></table>
        </div>
    </main>
    <div class="sidepanel hide" id="sidepanel_customers">
        <img src="../assets/images/close.png" class="sidepanel-close" onclick="close_sidepanel()"/>
        <div class="sidepanel-frame" id="sidepanel_customers_contents">
